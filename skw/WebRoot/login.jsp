  ...
  <head>
	...
	<style type="text/css">
		*{margin:0; padding:0; font-size:12px;}
		...
		#header{height:70px; width:100%; margin:0 auto; background:url(/skw/images/bg.png) repeat-x 100px -10px;}
		#login{width:380px; margin:100px auto;}
		.l-t1{background:url(/skw/images/bgpic1.gif) no-repeat -12px -56px; height:10px;font-family: 微软雅黑}
		.l-main{background:url(/skw/images/login-middle.gif) repeat-y -2px; height:200px;font-family: 微软雅黑}
		.l-b1{background:url(/skw/images/bgpic1.gif) no-repeat -12px -82px; height:10px;font-family: 微软雅黑}
		.l-ico{background:url(/skw/images/bgpic1.gif) no-repeat -250px -110px; padding-left:55px; font-size:14px; font-weight:bold;font-family: 微软雅黑}
		...
		#footer{height:70px; width:100%; margin:0 auto; background:url(/skw/images/bg.png) repeat-x bottom center;font-family: 微软雅黑}
    ...
    <div class="l-main">
        <form action="" name="ThisForm" method="post" >
            <table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td colspan="3" class="l-ico">餐饮食客网</td>
                </tr>
                <tr>
