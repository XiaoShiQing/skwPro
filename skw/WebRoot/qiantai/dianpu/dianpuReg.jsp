			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<div class="entry">
						    <form action="<%=path %>/dianpuReg.action" name="form1" method="post">
								 <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
									...
									<tr>
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
											<input type="text" name="lianxiren" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
										<td height="30" align="center" bgcolor="#F9F9F9" style="font-size: 11px;">
									...
									<tr>
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
											<input type="text" name="dizhi" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
										<td height="30" align="center" bgcolor="#F9F9F9" style="font-size: 11px;">
										...
										<td bgcolor="#FFFFFF">
											&nbsp;
                                            <input type="text" name="jieshao" style="width: 250px;"/>
										</td>
									</tr>
									<tr>
